...
__webpack_require__.d(__webpack_exports__, {
  ...
  "default": () => (/* binding */ next_edge_app_route_loaderabsolutePagePath_private_next_app_dir_2Fapi_2Fnews_2Froute_ts_page_2Fapi_2Fnews_2Froute_appDirLoader__3D_3D_nextConfigOutput_standalone_preferredRegion_middlewareConfig_e30_3D_)
});

// NAMESPACE OBJECT: ./src/app/api/news/route.ts
...
// NAMESPACE OBJECT: ./node_modules/next/dist/build/webpack/loaders/next-app-loader.js?name=app%2Fapi%2Fnews%2Froute&page=%2Fapi%2Fnews%2Froute&pagePath=private-next-app-dir%2Fapi%2Fnews%2Froute.ts&appDir=%2FUsers%2Fdenizhan%2FDocuments%2FWindsurf%2Fprotekanalitik%2Fsrc%2Fapp&appPaths=%2Fapi%2Fnews%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&preferredRegion=&middlewareConfig=e30%3D!./src/app/api/news/route.ts?__next_edge_ssr_entry__
...
;// CONCATENATED MODULE: ./src/app/api/news/route.ts
    ...
    try {
        ...
        `;
                ...
                if (result.success && result.data) {
                    ...
                    return (0,api_response/* createSuccessResponse */.x_)(result.data, "News fetched successfully", {
                        total,
                        limit,
                        offset,
        ...
        const mockNews = [
            {
                ...
                content: "Gıda ve i\xe7ecek end\xfcstrisinde kritik \xf6nem taşıyan BRIX değeri \xf6l\xe7\xfcmlerinde devrim niteliğinde bir yenilik... [Detaylı i\xe7erik]",
            ...
            },
            {
                ...
                content: "Su aktivitesi \xf6l\xe7\xfcmlerinde g\xfcvenilir sonu\xe7lar elde etmek i\xe7in kalibrasyon protokolleri... [Detaylı i\xe7erik]",
            ...
            },
            {
                ...
                content: "Modern laboratuvar y\xf6netiminde otomasyon \xe7\xf6z\xfcmlerinin rol\xfc... [Detaylı i\xe7erik]",
        ...
        if (search) {
            ...
            filteredNews = filteredNews.filter((news)=>news.title.toLowerCase().includes(searchLower) || news.content.toLowerCase().includes(searchLower) || news.summary.toLowerCase().includes(searchLower) || news.tags.toLowerCase().includes(searchLower));
        }
        // Apply pagination
        const total = filteredNews.length;
        const paginatedNews = filteredNews.slice(offset, offset + limit);
        return (0,api_response/* createSuccessResponse */.x_)(paginatedNews, "News fetched successfully (development mode)", {
            total,
            limit,
            offset,
            hasMore: offset + limit < total,
        ...
        return api_response/* CommonErrors */.Gl.SERVER_ERROR("Failed to fetch news");
    }
}
...
async function POST(request) {
    try {
        ...
        const validation = (0,api_response/* validateRequiredFields */.MN)(newsData, requiredFields);
        ...
        const newsId = newsData.id || database/* DatabaseUtils */.l3.generateId();
        const slug = newsData.slug || database/* DatabaseUtils */.l3.generateSlug(newsData.title);
        // Try D1 database first
        if (d1Database.isAvailable()) {
            try {
                // Check for duplicate slug
                const slugCheckResult = await d1Database.executeQuery("SELECT COUNT(*) as count FROM news WHERE slug = ?", [
                    slug
                ]);
                if (slugCheckResult.success && slugCheckResult.data?.[0] && slugCheckResult.data[0].count > 0) {
                    return (0,api_response/* createErrorResponse */.jl)("A news article with this slug already exists", "DUPLICATE_SLUG", 409);
                }
                ...
                const newNews = {
                    ...
                    content: database/* ValidationUtils */.v$.sanitizeHtml(newsData.content),
                ...
                if (insertResult.success) {
                    ...
                    return api_response/* DatabaseResponses */.$X.CREATED(newNews, "News article");
                } else {
        ...
        return api_response/* DatabaseResponses */.$X.CREATED(newNews, "News article (development mode)");
    } catch (error) {
        console.error("News creation error:", error);
        return api_response/* CommonErrors */.Gl.SERVER_ERROR("Failed to create news article");
    }
}
...
const routeModule = new module_compiled.AppRouteRouteModule({
    ...
    resolvedPagePath: "/Users/denizhan/Documents/Windsurf/protekanalitik/src/app/api/news/route.ts",
    nextConfigOutput,
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-edge-app-route-loader/index.js?absolutePagePath=private-next-app-dir%2Fapi%2Fnews%2Froute.ts&page=%2Fapi%2Fnews%2Froute&appDirLoader=%3D%3D&nextConfigOutput=standalone&preferredRegion=&middlewareConfig=e30%3D!

// Import the userland code.

const ComponentMod = route_next_edge_ssr_entry_namespaceObject;
/* harmony default export */ const next_edge_app_route_loaderabsolutePagePath_private_next_app_dir_2Fapi_2Fnews_2Froute_ts_page_2Fapi_2Fnews_2Froute_appDirLoader__3D_3D_nextConfigOutput_standalone_preferredRegion_middlewareConfig_e30_3D_ = (edge_route_module_wrapper/* EdgeRouteModuleWrapper */.a.wrap(routeModule));
...
/******/ (_ENTRIES = typeof _ENTRIES === "undefined" ? {} : _ENTRIES)["middleware_app/api/news/route"] = __webpack_exports__;
/******/ }
]);
