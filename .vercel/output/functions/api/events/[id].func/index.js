...
__webpack_require__.d(__webpack_exports__, {
  ...
  "default": () => (/* binding */ next_edge_app_route_loaderabsolutePagePath_private_next_app_dir_2Fapi_2Fevents_2F_5Bid_5D_2Froute_ts_page_2Fapi_2Fevents_2F_5Bid_5D_2Froute_appDirLoader__3D_nextConfigOutput_standalone_preferredRegion_middlewareConfig_e30_3D_)
});

// NAMESPACE OBJECT: ./src/app/api/events/[id]/route.ts
...
// NAMESPACE OBJECT: ./node_modules/next/dist/build/webpack/loaders/next-app-loader.js?name=app%2Fapi%2Fevents%2F%5Bid%5D%2Froute&page=%2Fapi%2Fevents%2F%5Bid%5D%2Froute&pagePath=private-next-app-dir%2Fapi%2Fevents%2F%5Bid%5D%2Froute.ts&appDir=%2FUsers%2Fdenizhan%2FDocuments%2FWindsurf%2Fprotekanalitik%2Fsrc%2Fapp&appPaths=%2Fapi%2Fevents%2F%5Bid%5D%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&preferredRegion=&middlewareConfig=e30%3D!./src/app/api/events/[id]/route.ts?__next_edge_ssr_entry__
...
;// CONCATENATED MODULE: ./src/app/api/events/[id]/route.ts
    ...
    try {
        ...
        if (db) {
            try {
                ...
                event = await db.prepare("SELECT * FROM events WHERE id = ?").bind(params.id).first();
                if (event) {
        ...
        if (!event) {
            return (0,api_response/* createErrorResponse */.jl)("Event not found", "EVENT_NOT_FOUND", 404);
        }
        return (0,api_response/* createSuccessResponse */.x_)(event, "Event fetched successfully");
    } catch (error) {
        console.error("Event fetch error:", error);
        return api_response/* CommonErrors */.Gl.SERVER_ERROR("Failed to fetch event");
    }
}
    ...
    try {
        ...
        if (db) {
            try {
                ...
                const existingEvent = await db.prepare("SELECT * FROM events WHERE id = ?").bind(params.id).first();
                if (!existingEvent) {
                    return (0,api_response/* createErrorResponse */.jl)("Event not found", "EVENT_NOT_FOUND", 404);
                }
                // Prepare update data
        ...
        `).bind(...values).run();
                // Fetch updated event
                const updatedEvent = await db.prepare("SELECT * FROM events WHERE id = ?").bind(params.id).first();
                console.log(`Event updated in D1: ${params.id} by user ${authResult.user.username}`);
                return (0,api_response/* createSuccessResponse */.x_)(updatedEvent, "Event updated successfully");
            } catch (dbError) {
                console.error("D1 event update error:", dbError);
                return api_response/* CommonErrors */.Gl.SERVER_ERROR("Failed to update event in database");
            }
        } else {
            ...
            return (0,api_response/* createSuccessResponse */.x_)(mockUpdatedEvent, "Event updated successfully");
        }
    } catch (error) {
        console.error("Event update error:", error);
        return api_response/* CommonErrors */.Gl.SERVER_ERROR("Failed to update event");
    }
}
// DELETE etkinlik sil
async function DELETE(request, { params }) {
    try {
        ...
        if (db) {
            try {
                // Check if event exists
                const existingEvent = await db.prepare("SELECT id, title FROM events WHERE id = ?").bind(params.id).first();
                if (!existingEvent) {
                    return (0,api_response/* createErrorResponse */.jl)("Event not found", "EVENT_NOT_FOUND", 404);
                }
                // Delete from D1
                ...
                return (0,api_response/* createSuccessResponse */.x_)({
                    id: params.id,
                    title: existingEvent.title
                }, "Event deleted successfully");
            } catch (dbError) {
                console.error("D1 event deletion error:", dbError);
                return api_response/* CommonErrors */.Gl.SERVER_ERROR("Failed to delete event from database");
            }
        } else {
            // Fallback for development
        ...
        return api_response/* CommonErrors */.Gl.SERVER_ERROR("Failed to delete event");
    }
}
...
const routeModule = new module_compiled.AppRouteRouteModule({
    ...
    resolvedPagePath: "/Users/denizhan/Documents/Windsurf/protekanalitik/src/app/api/events/[id]/route.ts",
    nextConfigOutput,
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-edge-app-route-loader/index.js?absolutePagePath=private-next-app-dir%2Fapi%2Fevents%2F%5Bid%5D%2Froute.ts&page=%2Fapi%2Fevents%2F%5Bid%5D%2Froute&appDirLoader=%3D&nextConfigOutput=standalone&preferredRegion=&middlewareConfig=e30%3D!

// Import the userland code.

const ComponentMod = route_next_edge_ssr_entry_namespaceObject;
/* harmony default export */ const next_edge_app_route_loaderabsolutePagePath_private_next_app_dir_2Fapi_2Fevents_2F_5Bid_5D_2Froute_ts_page_2Fapi_2Fevents_2F_5Bid_5D_2Froute_appDirLoader__3D_nextConfigOutput_standalone_preferredRegion_middlewareConfig_e30_3D_ = (edge_route_module_wrapper/* EdgeRouteModuleWrapper */.a.wrap(routeModule));
...
/******/ var __webpack_exports__ = (__webpack_exec__(1386));
/******/ (_ENTRIES = typeof _ENTRIES === "undefined" ? {} : _ENTRIES)["middleware_app/api/events/[id]/route"] = __webpack_exports__;
/******/ }
]);
