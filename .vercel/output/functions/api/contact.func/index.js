...
__webpack_require__.d(__webpack_exports__, {
  ...
  "default": () => (/* binding */ next_edge_app_route_loaderabsolutePagePath_private_next_app_dir_2Fapi_2Fcontact_2Froute_ts_page_2Fapi_2Fcontact_2Froute_appDirLoader__3D_3D_nextConfigOutput_standalone_preferredRegion_middlewareConfig_e30_3D_)
});

// NAMESPACE OBJECT: ./src/app/api/contact/route.ts
...
// NAMESPACE OBJECT: ./node_modules/next/dist/build/webpack/loaders/next-app-loader.js?name=app%2Fapi%2Fcontact%2Froute&page=%2Fapi%2Fcontact%2Froute&pagePath=private-next-app-dir%2Fapi%2Fcontact%2Froute.ts&appDir=%2FUsers%2Fdenizhan%2FDocuments%2FWindsurf%2Fprotekanalitik%2Fsrc%2Fapp&appPaths=%2Fapi%2Fcontact%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&preferredRegion=&middlewareConfig=e30%3D!./src/app/api/contact/route.ts?__next_edge_ssr_entry__
...
async function GET(request) {
    try {
        ...
        if (d1_database/* d1Database */.ki.isAvailable()) {
            try {
                // Build WHERE clause
                const conditions = [];
                const params = [];
                ...
                const result = await d1_database/* d1Database */.ki.getRecords("contact_messages", {
                    where: whereClause,
                    params,
                ...
                if (result.success && result.data) {
                    return (0,api_response/* createSuccessResponse */.x_)(result.data, "Contact messages fetched successfully", {
        ...
        const mockMessages = [
            {
                ...
                subject: "BRIX \xd6l\xe7\xfcm Cihazı Hakkında Bilgi",
                message: "Merhaba, şirketimizde kullanmak \xfczere BRIX \xf6l\xe7\xfcm cihazları hakkında detaylı bilgi almak istiyorum. Fiyat teklifi g\xf6nderebilir misiniz?",
            ...
            },
            {
                ...
                subject: "Su Aktivitesi \xd6l\xe7\xfcm Cihazı Teknik Destek",
            ...
            },
            {
                ...
                company: "\xd6zg\xfcr Danışmanlık",
                position: "Genel M\xfcd\xfcr",
                subject: "İş Birliği Fırsatları",
                message: "Distrib\xfct\xf6rl\xfck konusunda g\xf6r\xfcşmek istiyoruz. Uygun bir zamanda toplantı ayarlayabilir miyiz?",
                ...
                response_notes: "Toplantı 15 Şubat i\xe7in planlandı",
            ...
            },
            {
                ...
                company: "Ankara \xdcniversitesi",
                position: "Araştırma G\xf6revlisi",
                subject: "Akademik İndirim Bilgisi",
                message: "Araştırma projemiz i\xe7in magnetik karıştırıcı almayı planlıyoruz. Akademik indirim uygulanıyor mu?",
                message_type: "satis",
            ...
            },
            {
                ...
                position: "M\xfcd\xfcr",
                subject: "Genel Bilgi Talebi",
                message: "\xdcr\xfcn kataloğunuzu incelemek istiyoruz. PDF olarak g\xf6nderebilir misiniz?",
                message_type: "genel",
                interested_products: "",
                budget_range: "",
                timeline: "",
                ...
                response_notes: "Katalog e-posta ile g\xf6nderildi",
        ...
        if (search) {
            ...
            filteredMessages = filteredMessages.filter((msg)=>msg.first_name?.toLowerCase().includes(searchLower) || msg.last_name?.toLowerCase().includes(searchLower) || msg.email.toLowerCase().includes(searchLower) || msg.subject.toLowerCase().includes(searchLower) || msg.message.toLowerCase().includes(searchLower) || msg.company?.toLowerCase().includes(searchLower));
        }
        // Apply pagination
        const total = filteredMessages.length;
        const paginatedMessages = filteredMessages.slice(offset, offset + limit);
        return (0,api_response/* createSuccessResponse */.x_)(paginatedMessages, "Contact messages fetched successfully (development mode)", {
            total,
            limit,
            offset,
        ...
        return api_response/* CommonErrors */.Gl.SERVER_ERROR("Failed to fetch contact messages");
    }
}
...
async function POST(request) {
    try {
        ...
        if (!hasName && !hasFirstName) {
            return (0,api_response/* createErrorResponse */.jl)("Either name or first_name is required", "MISSING_REQUIRED_FIELDS", 400);
        }
        ...
        const validation = (0,api_response/* validateRequiredFields */.MN)(messageData, requiredFields);
        ...
        if (d1_database/* d1Database */.ki.isAvailable()) {
            try {
                ...
                const rateLimitResult = await d1_database/* d1Database */.ki.executeQuery("SELECT COUNT(*) as count FROM contact_messages WHERE ip_address = ? AND created_at > ?", [
                    clientIP,
                    tenMinutesAgo
                ]);
                if (rateLimitResult.success && rateLimitResult.data?.[0]?.count >= 3) {
                    return (0,api_response/* createErrorResponse */.jl)("Bu IP adresinden son 10 dakikada \xe7ok fazla mesaj g\xf6nderildi. L\xfctfen bekleyiniz.", "RATE_LIMIT_EXCEEDED", 429);
                }
                // Insert message into D1
                const insertResult = await d1_database/* d1Database */.ki.insertRecord("contact_messages", newMessage);
                if (insertResult.success) {
                    ...
                    return api_response/* DatabaseResponses */.$X.CREATED(publicResponse, "Contact message");
                } else {
                    console.error("Failed to save contact message to D1:", insertResult.error);
                    return api_response/* CommonErrors */.Gl.SERVER_ERROR("Failed to save contact message");
                }
            } catch (d1Error) {
                console.error("D1 database error:", d1Error);
                return api_response/* CommonErrors */.Gl.SERVER_ERROR("Database error occurred");
            }
        }
        ...
        return api_response/* DatabaseResponses */.$X.CREATED(publicResponse, "Contact message (development mode)");
    } catch (error) {
        console.error("Contact message creation error:", error);
        return api_response/* CommonErrors */.Gl.SERVER_ERROR("Failed to send contact message");
    }
}
...
const routeModule = new module_compiled.AppRouteRouteModule({
    ...
    resolvedPagePath: "/Users/denizhan/Documents/Windsurf/protekanalitik/src/app/api/contact/route.ts",
    nextConfigOutput,
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-edge-app-route-loader/index.js?absolutePagePath=private-next-app-dir%2Fapi%2Fcontact%2Froute.ts&page=%2Fapi%2Fcontact%2Froute&appDirLoader=%3D%3D&nextConfigOutput=standalone&preferredRegion=&middlewareConfig=e30%3D!

// Import the userland code.

const ComponentMod = route_next_edge_ssr_entry_namespaceObject;
/* harmony default export */ const next_edge_app_route_loaderabsolutePagePath_private_next_app_dir_2Fapi_2Fcontact_2Froute_ts_page_2Fapi_2Fcontact_2Froute_appDirLoader__3D_3D_nextConfigOutput_standalone_preferredRegion_middlewareConfig_e30_3D_ = (edge_route_module_wrapper/* EdgeRouteModuleWrapper */.a.wrap(routeModule));
...
/******/ var __webpack_exports__ = (__webpack_exec__(4310));
/******/ (_ENTRIES = typeof _ENTRIES === "undefined" ? {} : _ENTRIES)["middleware_app/api/contact/route"] = __webpack_exports__;
/******/ }
]);
