...
__webpack_require__.d(__webpack_exports__, {
  ...
  "default": () => (/* binding */ next_edge_app_route_loaderabsolutePagePath_private_next_app_dir_2Fapi_2Fupload_2Froute_ts_page_2Fapi_2Fupload_2Froute_appDirLoader__nextConfigOutput_standalone_preferredRegion_middlewareConfig_e30_3D_)
});
...
// NAMESPACE OBJECT: ./node_modules/next/dist/build/webpack/loaders/next-app-loader.js?name=app%2Fapi%2Fupload%2Froute&page=%2Fapi%2Fupload%2Froute&pagePath=private-next-app-dir%2Fapi%2Fupload%2Froute.ts&appDir=%2FUsers%2Fdenizhan%2FDocuments%2FWindsurf%2Fprotekanalitik%2Fsrc%2Fapp&appPaths=%2Fapi%2Fupload%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&preferredRegion=&middlewareConfig=e30%3D!./src/app/api/upload/route.ts?__next_edge_ssr_entry__
...
function validateFile(file, allowedTypes) {
    ...
    if (!allAllowedTypes.includes(file.type)) {
        errors.push("Desteklenmeyen dosya t\xfcr\xfc");
    }
    // Get file extension
...
function generateUniqueFilename(originalName, prefix = "") {
    ...
    // Sanitize filename
    const sanitizedName = nameWithoutExt.toLowerCase().replace(/[^a-z0-9]/g, "-").replace(/-+/g, "-").replace(/^-|-$/g, "");
    const filename = `${prefix}${timestamp}-${randomString}-${sanitizedName}.${extension}`;
    return filename;
}
// Upload to R2 (for Cloudflare Workers environment)
async function uploadToR2(bucket, file, path, filename, uploadedBy) {
    try {
...
async function uploadToLocal(file, path, filename) {
    try {
        const finalFilename = filename || generateUniqueFilename(file.name);
...
async function uploadFile(file, uploadType, filename, bucket) {
    // Validate file first
...
async function getFileInfoFromR2(bucket, key) {
    try {
...
function getOptimizedImageUrl(originalUrl, width, height, quality) {
...
function getThumbnailUrl(originalUrl, size = 150) {
...
async function POST(request) {
    try {
        ...
        if (!authResult.success) {
            return next_response/* default */.Z.json({
                success: false,
                error: "Ge\xe7ersiz kimlik doğrulama",
                code: "INVALID_TOKEN"
            }, {
                status: 401
            });
        ...
        const uploadType = formData.get("type") || "products";
        ...
        const uploadPath = UPLOAD_CONFIG.paths[uploadType];
        // Upload to R2 (Edge Runtime compatible)
        const env = process.env;
        const bucket = env.UPLOADS// R2Bucket from Cloudflare environment
        ;
        let publicUrl;
        if (bucket) {
            // Production: Upload to R2
            const r2Result = await uploadToR2(bucket, file, uploadPath, uniqueFileName, authResult.user?.username);
            if (!r2Result.success) {
                return next_response/* default */.Z.json({
                    success: false,
        ...
        return next_response/* default */.Z.json({
            success: false,
            error: "Dosya y\xfcklenirken hata oluştu",
            code: "UPLOAD_ERROR"
        }, {
            status: 500
        });
...
async function PUT(request) {
    try {
        ...
        return next_response/* default */.Z.json({
            success: false,
            error: "Dosyalar y\xfcklenirken hata oluştu",
...
const routeModule = new module_compiled.AppRouteRouteModule({
    ...
    resolvedPagePath: "/Users/denizhan/Documents/Windsurf/protekanalitik/src/app/api/upload/route.ts",
    nextConfigOutput,
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-edge-app-route-loader/index.js?absolutePagePath=private-next-app-dir%2Fapi%2Fupload%2Froute.ts&page=%2Fapi%2Fupload%2Froute&appDirLoader=&nextConfigOutput=standalone&preferredRegion=&middlewareConfig=e30%3D!

// Import the userland code.

const ComponentMod = route_next_edge_ssr_entry_namespaceObject;
/* harmony default export */ const next_edge_app_route_loaderabsolutePagePath_private_next_app_dir_2Fapi_2Fupload_2Froute_ts_page_2Fapi_2Fupload_2Froute_appDirLoader__nextConfigOutput_standalone_preferredRegion_middlewareConfig_e30_3D_ = (edge_route_module_wrapper/* EdgeRouteModuleWrapper */.a.wrap(routeModule));
...
/******/ var __webpack_exports__ = (__webpack_exec__(1006));
/******/ (_ENTRIES = typeof _ENTRIES === "undefined" ? {} : _ENTRIES)["middleware_app/api/upload/route"] = __webpack_exports__;
/******/ }
]);
