...
const getRelatedProductsViaAPI = async (categoryId, subcategoryId, currentProductId)=>{
    try {
        const response = await fetch("/api/products?category_id=".concat(categoryId, "&subcategory_id=").concat(subcategoryId, "&limit=5"));
        const data = await response.json();
...
/******/ __webpack_require__.O(0, [1176,9751,4166,4403,2971,993,1744], function() { return __webpack_exec__(9180); });
