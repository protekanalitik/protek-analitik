...
const generateProductUrl = function(product) {
    let categories = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [];
    ...
    const findSubcategoryKey = (categoryName, subcategoryName)=>{
        ...
        if (category) {
            ...
            const subcategory = (_category_subcategories = category.subcategories) === null || _category_subcategories === void 0 ? void 0 : _category_subcategories.find((sub)=>sub.name === subcategoryName);
            if (subcategory) {
...
function Products() {
    ...
    const subcategories = selected === "all" ? [] : ((_categories_find = categories.find((cat)=>cat.key === selected)) === null || _categories_find === void 0 ? void 0 : _categories_find.subcategories) || [];
    ...
    if (selected === "all") {
        ...
        filteredProducts = products.filter((product)=>{
            var _categories_find, _categories_find_subcategories_find, _categories_find_subcategories, _categories_find1;
            return product.category === ((_categories_find = categories.find((cat)=>cat.key === selected)) === null || _categories_find === void 0 ? void 0 : _categories_find.name) && product.subcategory === ((_categories_find1 = categories.find((cat)=>cat.key === selected)) === null || _categories_find1 === void 0 ? void 0 : (_categories_find_subcategories = _categories_find1.subcategories) === null || _categories_find_subcategories === void 0 ? void 0 : (_categories_find_subcategories_find = _categories_find_subcategories.find((sub)=>sub.key === selectedSub)) === null || _categories_find_subcategories_find === void 0 ? void 0 : _categories_find_subcategories_find.name);
        });
    } else {
        filteredProducts = products.filter((product)=>{
            var _categories_find;
            return product.category === ((_categories_find = categories.find((cat)=>cat.key === selected)) === null || _categories_find === void 0 ? void 0 : _categories_find.name);
        });
    }
