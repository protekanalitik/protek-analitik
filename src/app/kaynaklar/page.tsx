                  ...
                  <div className="space-y-6">
                    {newsData.filter(news => news.category === 'sirket-haberleri').map((news, index) => (
                      <article key={index} className="flex flex-col md:flex-row gap-6 p-6 border border-gray-200 rounded-xl hover:shadow-md transition-shadow">
                        <div className="relative w-full md:w-48 h-48 md:h-32 rounded-lg flex-shrink-0">
                          <Image 
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4 text-sm text-gray-500 min-w-0">
                              ...
                              <div className="flex flex-wrap gap-1">
                                {parseTagsArray(news.tags).slice(0, 3).map((tag: string, tagIndex: number) => (
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center space-x-4 text-sm text-gray-500 min-w-0">
                                ...
                                <div className="flex flex-wrap gap-1">
                                  {parseTagsArray(story.tags).slice(0, 3).map((tag: string, tagIndex: number) => (
                  ...
                  <div className="space-y-8">
                    <div className="grid grid-cols-1 gap-6">
                      <div className="p-6 bg-blue-50 rounded-xl border border-blue-200">
                        <h3 className="font-semibold text-blue-900 mb-3">Protek Analitik Katalog</h3>
                        <p className="text-blue-700 text-sm mb-4">
                          Ürün ve hizmetlerimizin tamamını incelemek için kataloğumuzu görüntüleyin.
                        </p>
                        <a
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="p-6 bg-teal-50 border border-teal-200 rounded-xl">
                      <div className="text-center">
                        ...
                        <a href="tel:+902163293960" className="text-teal-600 hover:text-teal-800 font-medium">
                          +90 (216) 329 39 60
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="p-6 bg-blue-50 border border-blue-200 rounded-xl">
                      <div className="text-center">
                        ...
                        <a href="mailto:info@protekanalitik.com" className="text-blue-600 hover:text-blue-800 font-medium">
                          info@protekanalitik.com
                        </a>
                      </div>
                    </div>
